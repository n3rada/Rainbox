...
def parsing():
    ...
    parser.add_argument('-a',
                        ...
                        type=str,
                        default=None,
                        help="Alphabet case: low, up or mix")
    ...
    parser.add_argument("-w",
                        '--wordlist',
                        action='store_true',
                        help="Wordlist output activated.")
    ...
    parser.add_argument(
        ...
        nargs="?",
        help=
        "Enter the key to find here for testing the generator. Cannot be combined with wordlist !"
    )
...
def main():
    ...
    try:
        fragmentName = "FRAG_4_" + args.type.upper(
        ) + "-" + args.alphabet + "-" + str(args.punctuation)
    except TypeError:
        fragmentName = None
